...
function SSVoltar(id) {
    document.getElementById(id).style.webkitBoxShadow = "none";
}

function CSVoltar(id) {
    document.getElementById(id).style.webkitBoxShadow = "0px 3px 16px 3px rgb(153 153 153 / 54%)";
}

function SSContinuar(id) {
    document.getElementById(id).style.webkitBoxShadow = "none";
}

function CSContinuar(id) {
    document.getElementById(id).style.webkitBoxShadow = "0px 3px 16px 3px rgb(153 153 153 / 54%)";
}

function SSVoltarSite(id) {
    document.getElementById(id).style.webkitBoxShadow = "none";
}

function CSVoltarSite(id) {
    document.getElementById(id).style.webkitBoxShadow = "0px 3px 16px 3px rgb(153 153 153 / 54%)";
}

function SSCadastrar(id) {
    document.getElementById(id).style.webkitBoxShadow = "none";
}

function CSCadastrar(id) {
    document.getElementById(id).style.webkitBoxShadow = "0px 3px 16px 3px rgb(153 153 153 / 54%)";
}
...
function ocultarMostrar(id) {
    ...
    if (id == "voltar") {
        ...
        document.getElementById('cadastrar2').style.display = "none";
        document.getElementById('cadastrar3').style.display = "none";
        document.getElementById('cadastrar4').style.display = "none";
            ...
            if (totalP1 != 0) {
                ...
                if (totalP1 <= 1) { // 1
                    ...
                    if (peso == 3) {
                        ...
                        document.getElementById('cadastrar4').style.display = "inline-block";
                    ...
                    if (peso == 2) {
                        ...
                        document.getElementById('cadastrar2').style.display = "inline-block";
                        document.getElementById('continuar').style.display = "none";
                    }
                ...
                if (totalP1 > 1 && totalP1 <= 2) { // 2
                    ...
                    if (peso == 2) {
                        ...
                        document.getElementById('cadastrar3').style.display = "inline-block";
                        document.getElementById('continuar').style.display = "none";
                    }
